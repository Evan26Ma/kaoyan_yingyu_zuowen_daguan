...
一个由考研英语写作与阅读资料整理而成的静态学习网站，提供分类浏览、全文搜索、收藏、续背定位、中英文遮挡和整篇 PDF 打印。
...
- `content/`：从原始 MinerU HTML 拆分的 13 个来源页面，作为可追溯内容源。
...
收藏、已学、最近访问、续背位置、遮挡方式、阅读版式和主题偏好保存在浏览器的 `kaoyan-writing:v1` 本地存储项中，不会上传到服务器。
